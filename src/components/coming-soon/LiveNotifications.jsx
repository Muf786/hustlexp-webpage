...
const actions = [
  'joined the waitlist', 'earned Founder Badge', 'referred 3 friends', 
  'unlocked Bronze tier', 'earned +100 XP', 'completed a quest',
  'reached level 5', 'unlocked Silver tier', 'earned Gold tier'
];
...
const getNextNotification = () => {
  ...
  return {
    ...
    icon: [Zap, TrendingUp][Math.floor(Math.random() * 2)]
  };
};
...
export default function LiveNotifications() {
  ...
  useEffect(() => {
    ...
    // Show new notifications every 30 seconds
