...
export default function SocialProof() {
  ...
  return (
    <section className="relative py-28 px-4 bg-[#05030a] border-t border-white/10 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_left,rgba(139,92,246,0.16),transparent_55%)] pointer-events-none" />
      <div className="absolute -bottom-24 right-0 w-[420px] h-[420px] bg-fuchsia-500/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-3xl md:text-5xl font-semibold tracking-tight text-white mb-3 font-display">
            Join <span className="text-violet-300">{waitlistCount}+</span> professionals in Seattle
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="group relative bg-white/[0.04] backdrop-blur-sm p-8 rounded-3xl border border-white/10 hover:border-violet-400/40 transition-all hover:bg-white/[0.08]"
            >
